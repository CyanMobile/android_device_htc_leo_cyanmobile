...
public class LeoUpdaterActivity extends Activity {
	private static TextView textView;
	private static TextView buttonTextView;
	private static final String manifestURL = "https://raw.github.com/Squadzone/Leo-ROM/gingerbread/README";
...
/** Called when the activity is first created. */
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		buttonTextView = (TextView) findViewById(R.id.LeoUpdaterButton);
				...
				if (data != null) {
					...
					if (fileUri != null && !fileUri.toString().equals("")) {
						...
						if (filePath != null) {
							...
							try {
								checkDownloadedMD5.setAction(com.Leo.LeoUpdater.LeoUpdaterActivity.checkMD5(filePath, true));
							} catch (IOException e) {
								// TODO Auto-generated catch block
								checkDownloadedMD5.setAction(com.Leo.LeoUpdater.LeoUpdaterActivity.badFilePath());
							}
