...
PRODUCT_COPY_FILES += \
    ...
    device/htc/leo/prebuilt/02htcleo:system/etc/init.d/02htcleo

#Media profile
PRODUCT_COPY_FILES += \
    device/htc/leo/poweron.ogg:system/media/poweron.ogg \
    device/htc/leo/camera_click.ogg:system/media/audio/ui/camera_click.ogg \
    device/htc/leo/VideoRecord.ogg:system/media/audio/ui/VideoRecord.ogg

## Tweaks
PRODUCT_COPY_FILES += \
    device/htc/leo/70zipalign:system/etc/init.d/70zipalign \
    device/htc/leo/zipalign:system/bin/zipalign \
    device/htc/leo/check_data_app:system/bin/check_data_app \
    device/htc/leo/prebuilt/be_photo:system/etc/be_photo \
    device/htc/leo/prebuilt/be_movie:system/etc/be_movie

## application
PRODUCT_COPY_FILES += \
      device/htc/leo/app/Ice10.apk:system/app/Ice10.apk
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/leo/updater-script:scripts/updater-script \
    device/htc/leo/update-binary:scripts/update-binary \
    device/htc/leo/check_data_app:scripts/check_data_app
